...
class Hola_Alfredo_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Hola_Alfredo_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Hola_Alfredo_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/hola-alfredo-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/hola-alfredo-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function display_plugin_setup_page() {
		include_once( 'partials/hola-alfredo-admin-display.php' );
	}
